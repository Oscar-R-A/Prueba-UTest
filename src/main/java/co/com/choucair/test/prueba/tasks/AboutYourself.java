package co.com.choucair.test.prueba.tasks;

import co.com.choucair.test.prueba.userinterface.UTestPage;
import co.com.choucair.test.prueba.userinterface.UTestSingUp;
...
public class AboutYourself implements Task {
    ...
    public static AboutYourself register(String strName, String strLastName, String strMail, String strMonth, String strDay, String strYear) {
        return Tasks.instrumented(AboutYourself.class);
    }
